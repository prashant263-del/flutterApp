...
class ExternalAuditorDetails extends StatefulWidget {
  const ExternalAuditorDetails({super.key});

  @override
  State<ExternalAuditorDetails> createState() => AuditorsDetailsState();
}

class AuditorsDetailsState extends State<ExternalAuditorDetails> {
  ...
  getIndustryList() {
    payload = '{"opnfor": "200000", "act": "A-02"}';
    cFun.callAPI(payload).then((data) {
      setState(() {
        print(data);
        industryList = data['header'];
      });
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: const Text("SEBI Auditor Master"),
        ...
        child: ListView(
          children: [
            ...
            MultiSelectFormField(
              ...
              //   },
              // ],
              textField: 'IndustryVerticalName',
              valueField: 'IndustryVerticalID',
              okButtonLabel: 'OK',
  ...
  void performSchoolOperations() {
    if (id == null) {
      payload =
          '{"opnfor": "200000","act": "A-I","CreatedBy": "admin","UserRole": "102","fName":"' +
              fname.text +
              '","lName":"' +
              lname.text +
              '","Email":"' +
      ...
      // };
      payload =
          '{"opnfor": "200000","act": "A-U","CreatedBy": "admin","ModifiedBy": "admin","UserRole": "102","fName":"' +
              fname.text +
              '","lName":"' +
              lname.text +
              '","Email":"' +
